      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center space-y-4">
          <div class="text-gray-500 prose mx-auto">
            <h1
              class="flex justify-center text-3xl font-extrabold tracking-tight text-coolGray-800 dark:text-blueGray-200 sm:text-4xl"
...
@Component({
  metaInfo: {
    title: i18n.t("front.privacy.title").toString(),
  },
  components: {
    Header,
    Footer,
