  ...
  <div v-click-outside="closeDropdownUser" class="relative">
    <div class="inline-flex shadow-none rounded-sm divide-x divide-gray-300">
      <button
        ...
        class="bg-gray-50 border border-gray-100 focus:outline-none focus:ring-2 focus:ring-theme-100 focus:ring-offset-2 focus:ring-offset-theme-50 focus:text-theme-900 focus:z-10 font-medium hover:text-theme-800 inline-flex items-center relative rounded-full shadow-inner text-blueGray-400"
        :class="{
      ...
      >
        <img
          v-if="avatar"
          class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-blueGray-800"
          :src="avatar"
          alt="Avatar"
        />
