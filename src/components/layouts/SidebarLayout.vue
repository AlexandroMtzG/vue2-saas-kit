    ...
    <div class="h-screen flex overflow-hidden bg-gray-100 text-gray-800">
      ...
      <div v-if="sidebarOpen" class="md:hidden">
        <div class="fixed inset-0 flex z-40">
          ...
          >
            <div class="relative flex-1 flex flex-col max-w-xs w-full pb-4 bg-coolGray-900">
        ...
        <div class="flex flex-col w-64">
          <div class="flex flex-col h-0 flex-1 shadow-md bg-theme-600">
            <div class="flex-1 flex flex-col overflow-y-auto">
              <nav class="flex-1 px-2 py-4 space-y-3 bg-coolGray-900 select-none">
          ...
          <div class="flex-1 px-3 flex justify-between">
            <div class="flex-1 flex items-center">
              <div class="w-full flex md:ml-0">
                <div class="align-baseline w-full text-blueGray-200 pl-1">
                  <!-- Logo -->
                  <nav class="lg:hidden">
                    <router-link to="/app">
                      <img
