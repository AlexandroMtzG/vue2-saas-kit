<template>
  <div>
    <div v-if="showing" @keyup.enter="yes" @keypress.esc="no">
          ...
          <div>
            ...
            <div class="mt-3 text-center sm:mt-5">
              <h3
                ...
                id="modal-headline"
              >{{ question }}</h3>
              <p v-if="subtitle" v-html="subtitle" class="text-gray-500 text-sm mt-3"></p>

              <div v-if="inputType === 'email'" class="mt-4">
...
export default class ConfirmModal extends Vue {
  ...
  value: any = undefined;
  question!: string;
  yesTitle: TranslateResult = "";
  noTitle: TranslateResult = "";
  subtitle: TranslateResult = "";
  inputString: TranslateResult = "";
  mounted() {
